...
### Context
![Context](./docs/diagrams/level_1.png)
### Containers
![Containers](./docs/diagrams/level_2.png)

### ML training serive components
![ML training serive components](./docs/diagrams/level_2.png)
